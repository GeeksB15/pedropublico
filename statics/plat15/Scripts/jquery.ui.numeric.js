...
(function ($) {
    ...
    *
    */
    $.fn.numeric = function (decimalPlaces, decimal, callback) {
        decimal = (decimal === false) ? "" : decimal || ",";
        decimalPlaces = (decimalPlaces === false) ? 0 : decimalPlaces || 0;
        ...
        this.each(function() {
            ...
            if (decimalPlaces) {
                var val = $(this).val();
                if (val != "") {
                    $(this)[0].value = number_format(parseFloat(val), decimalPlaces, decimal, "");
                }
            }
        });
    ...
    $.fn.numeric.keypress = function (e) {
        ...
        if ((key < 48 || key > 57) && (!e.shiftKey && key != 45) && key != 0) {
